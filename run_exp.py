...
def main(rounds, seed, client_list, client_selection, CS_args, aggregation, Agg_args, client_train_config, client_test_config):  
    ...
    # Initialize dummy metrics for first round selection
    if rounds >= 1:
        for client in client_list:
            if 0 not in client.test_metrics:
                client.test_metrics[0] = {"accuracy": 0.0}
        
            if 0 not in client.time_util:
                client.time_util[0] = 0.0
